...
-------------------------------------------------------*/
	...
	$(window).scroll(function () {
		if ($("#header").offset().top > 50) {
			$("#header").addClass("menu-bg").removeClass("menu-bg-transparent");
		} else {
			$("#header").addClass("menu-bg-transparent").removeClass("menu-bg");
		}
	});
